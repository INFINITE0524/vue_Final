...
async function login() {
  ...
  try {
    ...
    document.cookie = `maxToken=${response.data.token}`
    router.push('/todo')
  } catch (error) {
    alert(error)
  }
    ...
    <div class="container loginPage vhContainer">
      ...
      <div v-if="status != 'signUp'">
        <form class="formControls" action="index.html">
          ...
          <input class="formControls_input" type="text" id="email" name="email" placeholder="請輸入email" required v-model="userInfomation.email"/>
          <span>此欄位不可留空</span>
          <label class="formControls_label" for="pwd">密碼</label>
          <input class="formControls_input" type="password" name="pwd" id="pwd" placeholder="請輸入密碼" required v-model="userInfomation.password"/>
          <input class="formControls_btnSubmit" type="button" value="登入" @click.prevent="login()"/>
      ...
      <div v-if="status == 'signUp'">
        <form class="formControls" action="index.html">
          ...
          <label class="formControls_label" for="email">Email</label>
          <input class="formControls_input" type="text" id="email" name="email" placeholder="請輸入 email" required v-model="signUpInfomation.email"/>
          <label class="formControls_label" for="name">您的暱稱</label>
          <input class="formControls_input" type="text" name="name" id="name" placeholder="請輸入您的暱稱" v-model="signUpInfomation.nickname"/>
          <label class="formControls_label" for="pwd">密碼</label>
          <input class="formControls_input" type="password" name="pwd" id="pwd" placeholder="請輸入密碼" required v-model="signUpInfomation.password"/>
          <label class="formControls_label" for="pwd">再次輸入密碼</label>
          <input class="formControls_input" type="password" name="pwd" id="pwd" placeholder="請再次輸入密碼" required v-model="signUpInfomation.passwordCheck"/>
